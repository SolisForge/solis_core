...
function(solis_register _target)
  ...
  if (${_FUNC_ARG_EXE})
    message(VERBOSE "  Registering executable \"${_target}\"")
  ...
  elseif(${_FUNC_ARG_LIB})
    ...
    message(VERBOSE "  Registering library \"${target_ns}::${_target}\"")
  ...
  elseif(${_FUNC_ARG_DEP})
    ...
    message(WARNING "No flag supplied for target \"${_target}\"!")
    return()
  endif()
